...
namespace Universal.EBI.MessageBus
{
    public class MessageBus : IMessageBus
    {
        ...
        public IDisposable RespondAsync<TRequest, TResponse>(Func<TRequest, Task<TResponse>> response)
            where TRequest : IntegrationEvent
            where TResponse : ResponseMessage
        {
            TryConnect();
            return _bus.Rpc.Respond<TRequest, TResponse>(response);
        }        
