...
{
    public class EducatorRepository : IEducatorRepository, IAggregateRoot
    {
        private readonly ReportContext _context;
        public IUnitOfWork UnitOfWork => _context;
        
        public EducatorRepository(ReportContext context)
        {
            _context = context;
        }       
        ...
        {
            return await _context.Educators.FirstOrDefaultAsync(c => c.Cpf.Equals(cpf));
        }
