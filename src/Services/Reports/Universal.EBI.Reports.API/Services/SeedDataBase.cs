                ...
                ctx.Classrooms.AddRange
                    (
                         new Classroom
                         {
                             ...
                             CreatedDate = DateTime.UtcNow.Date.AddDays(-1.0),
                             ...
                             Educator = new Educator
                             {
                                 ...
                                 CreatedDate = DateTime.UtcNow.Date.AddDays(-10.0),
                             ...
                             Children = new List<Child>
                             {
                                 new Child
                                 {
                                     ...
                                     ClassroomId = Guid.Parse("5811275e-de3e-4f33-81f2-3c7a92d1c27a"),
                                     Excluded = false,
                                     CreatedDate = DateTime.UtcNow.Date.AddDays(-5.0),
                                     CreatedBy = "currentUser",
                         ...
                         new Classroom
                         {
                             ...
                             Region = "São João I",
                             Church = "São Mateus II",
                             CreatedDate = DateTime.UtcNow.Date.AddDays(-4.0),
                             MeetingTime = DateTime.UtcNow.ToString("HH:mm"),
                             ClassroomType = (ClassroomType)Enum.Parse(typeof(ClassroomType), "Mixed", true),
                             Lunch = "Iogurt e Biscoito",
                             Educator = new Educator
