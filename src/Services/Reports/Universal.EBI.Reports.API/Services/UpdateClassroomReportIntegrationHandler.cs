...
{
    public class UpdateClassroomReportIntegrationHandler : BackgroundService
    {
        private readonly IMessageBus _bus;
        private readonly IServiceProvider _serviceProvider;        

        public UpdateClassroomReportIntegrationHandler(IServiceProvider serviceProvider, IMessageBus bus)
        {
        ...
        {            
            _bus.SubscribeAsync<UpdatedClassroomReportIntegrationEvent>("UpdatedClassroomReport", async message => await UpdateClassroom(message));
            _bus.AdvancedBus.Connected += OnConnect;
        }

        private async Task<bool> UpdateClassroom(UpdatedClassroomReportIntegrationEvent message)
        {
